...
export const updateMyHeadache = (user_id, headache_id, myState) => {
  console.log(
    "updateMyHeadache called - user_id",
    user_id,
    "headache_id",
    headache_id,
    "apiCall",
  ...
  return dispatch => {
    console.log("apiCall", apiCall);
    console.log("headaches.js/updateMyHeadache() - headache", headache_id);
